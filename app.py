...
def carica_dati():
  ...
  # Ricerca dinamica del file dei nuovi acquisti
  file_nuovi = None
  ...
  # Estrazione prezzi minimi da Totale.xlsx
  ...
  # Conversione sicura degli ID in stringhe pulite (evita blocchi nei merge)
...
st.markdown('Cerca un giocatore per analizzare lo storico e i prezzi d’asta.')
